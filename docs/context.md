...
2. Освещение, которое включается во время заката
3. Шторы, которые открываются вместе со срабатыванием будильника
4. Повышение и понижение температуры, когда можно включить/выключить кондиционер
5. Изменение влажности, когда можно изменить режим работы увлажнителя
6. Настройки - опционально, чуть позже )
